  ...
  return (
    <>
      <div className="relative w-full">
        <Navbar />
        <div className="bg-accent-500 absolute left-[30rem] top-[20rem] -z-10 size-[10rem] blur-[200px]"></div>
        <div className="">
        ...
        <div className="border-background-700 mb-[4rem] h-px w-full border-t"></div>
        <div className="flex flex-col p-32 pt-0">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="flex text-xl">
                but if you change the options, such as changing integer to
                float, like
              </span>
              <span className="bg-background-800 border-background-700 flex w-2/3 items-center justify-between rounded-lg border p-2 transition-colors">
                Range, 0-10, Float
